...
@RestController
@RequestMapping("clusterRelationship")
public class ClusterRelationshipController {
    ...
    @PostMapping("queryClusterAndRelationshipEntityListByClusterId")
    public List<ClusterAndRelationshipEntity> queryClusterAndRelationshipEntityListByClusterId(
        @RequestBody ClusterRelationshipEntity clusterRelationshipEntity) {
        return this.clusterRelationshipService.queryClusterAndRelationshipEntityListByClusterId(clusterRelationshipEntity);
    }
